<template>
    <div class="all_recettes">
        <div class="wrapper">
            <div class="content mt-5 h-auto mb-5"
                 dir="rtl">
                <div class="container">
                    <div class="row">
                            ...
                            <transition name="fade">
                                <div class="filter"
                                    ...
                                    <div class="d-flex flex-wrap w-100">
                                        <a href="#"
                                           @click="getRecipes()"
                                           class="fs-5 recipes-link text-black-50 m-3 p-2 rounded-pill pointer border fw-semibold text-decoration-none">All Recipes</a>
                                        <a href="#"
                        ...
                        <TransitionGroup name="fade"
                                         v-if="recipes !== 0">
                            <div class="col-12 col-md-6 col-lg-3 mt-3 position-relative"
                                 id="test"
                                ...
                                <div class="single_recipe"
                                    ...
                                    <div class="image position-relative">
                                        <div class="position-absolute text-center w-100"
                                            ...
                                            ">
                                            <button type="button"
                                                    class="bg-transparent border-0 btn rounded-circle">
                                    ...
                                    <div class="title h5 mt-1">
                                        <a :href="'/recipes/' + recipe.id"
                                           class="text-dark text-decoration-none">{{ recipe.name }}</a>
                                    </div>
                                    <div class="author">
                                        <a :href="
                                            '/user/profile/' +
                                    ...
                                    <div class="type">
                                        <a :href="
                                            '/similar/' + recipe.type_recipe.type
                                        "
                                           class="text-decoration-none text-success font-14">{{ recipe.type_recipe.type }}</a>
                                    </div>
                                </div>
                            </div>
                        </TransitionGroup>
