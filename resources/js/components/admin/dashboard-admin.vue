                    ...
                    <li class="nav-icon mr-2" @click="show_messages = !show_messages">
                        ...
                        <Transition name="fade">
                            <div class="bg-white messages mx-4 p-2 position-absolute shadow top-100 w-50 z-5555"
                                style="right: 8vh;" v-show="show_messages">
                                <div class="align-items-start border-bottom d-flex mb-1 message"><img
                                        src="https://i.pravatar.cc/80" class="rounded-circle">
                                    <div class="d-flex flex-column justify-content-start mx-2"><a href="#"
                                            class="text-capitalize text-decoration-nonee">Name
                                            User</a>
                                        <div class="fs-6 lh-lg message-text">Lorem ipsum dolor sit amet consectetur
                                            adipisicing elit. Sed
                                            perferendis maiores repellat debitis optio neque atque molestiae. Culpa ea cum
                                            rerum corrupti
