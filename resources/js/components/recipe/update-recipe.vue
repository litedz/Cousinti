<template>
    ...
    <div class="update-recipe bg-light mx-auto mb-5 p-3 rounded w-75"
         dir="rtl">
        ...
        <FormKit type="form"
            ...
            <select class="form-select"
                    ...
                    id="select_type">
                <option v-for="val in this.types_recipe"
                        :value="val.id"
                        :key="val">
                    {{ val.type }}
                </option>
            ...
            <div class="ingredients border-bottom"
                ...
                <div class="d-flex w-50 align-items-center"
                    ...
                    <FormKit type="button"
                             ...
                             @keyup.enter="add_ingredient_table"
                             :actions="false"
        ...
        <div class="images mt-4">
            ...
            <div class="headImage position-relative"
            ...
            <div class="otherImages d-flex">
                <div v-for="image in this.update_recipe.images_recipe"
                     :key="image"
        ...
        <FormKit type="form"
            ...
            <FormKit type="button"
                     ...
                     :disabled="!valid"
                     @click="add_recipe()">تحديث الوصفة<span class="fa fa-plus-circle m-2 text-white"></span></FormKit>
        </FormKit>
    </div>
</template>
                ...
                axios({
                    ...
                    .then((response) => {
                        ...
                        if (recipe) {
                            ...
                            this.url_video = "https://www.youtube.com/" + recipe.url_video;
