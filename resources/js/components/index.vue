<template>
    ...
    <div class="header position-relative overflow-hidden" dir="rtl">
        ...
        <div class="h-auto index-nav position-fixed top-0 w-100 z-9999" style="">
            <div class="d-flex flex-row font-amiri justify-content-center nav p-3" style="">
                <li class="fs-3"><a href="#" class="p-2 rounded text-decoration-none" style="
    color: darkcyan;
">حلويات</a></li>
            </div>
        </div>

        <div class="position-absolute text-center w-50 z-9999" style="left:25%;top:10%;mix-blend-mode: screen;">
            <div class="bg-white display-1 fw-bolder text text-black" style="letter-spacing:15px;">COUSINTI</div>
        ...
        <div class="center-text h-50 position-absolute w-100 z-5555 d-flex justify-content-center flex-column"
            style="top: 25%">
            <div class="mt-5 mb-5">
                <div class="title display-4 font-amiri text-center text-white fw-bolder" id="title"></div>
            </div>
            <div class="steps">
                <div class="container">
                    <div class="bg-body h-auto mt-sm-5 mx-sm-auto shape col-12 col-md-5"
                        ...
                        <div class="d-flex flex-column h-75 items justify-content-around p-5" dir="rtl">
                            ...
                            <div class="font-amiri random text-center"><button class="btn fs-4 fw-bolder mt-5 w-50"
                                    @click="activeComponent = 'random-recipe'" style="background:#344040;">اختيار
                                    وصفة</button></div>
                        </div>
                    </div>
                </div>
    ...
    <section class="sing_up bg-dark position-relative d-flex align-items-center mb-5 font-amiri">
        ...
        <div class="container position-relative text-white" style="z-index: 22;">
            ...
            <div class="align-items-center align-items-end d-flex flex-column justify-content-center">
                ...
                <div class="fs-5 lh-lg text-right">أن تولد مثل هذا النص أو العديد من النصوص أن تولد مثل هذا النص أو
                    العديد من النصوص أنمن النصوص أن تولد مثل هذا النص أوالعديد من النصوص أنمن النصوص أن تولد مثل هذا
                    النص أو العديد من النصوص أنمن النصوص أن تولد مثل هذا النص أو العديد من النصوص أنمن النصوص أن تولد
                    مثل هذا النص أو العديد من النصوص أن تولد مثل هذا النص أو العديد من النصوص أن تولد مثل هذا
                </div>
                ...
                <div class="d-flex items position-relative" style="right: 0px;" id="slideSweats" dir="rtl">
                    <div id='item-slider' data-show='1' class="bg-light h-100 item mx-1 p-3 rounded"
                        ...
                        <div class="d-flex flex-column justify-content-center">
                            <div class="img"><img src="https://picsum.photos/id/111/150" alt="" class="w-100">
                                <div class="align-items-baseline d-flex justify-content-between p-1">
                                    <div class="info">
                                        <div class="fs-4 fw-bolder text-black-500"><a
                                                class="text-decoration-none text-first pointer" href="#">Name</a></div>
                    ...
                    <div id='item-slider' data-show='2' class="bg-light h-100 item mx-1 p-3 rounded"
                        style="width:350px;transition:all 1s">
                        <div class="d-flex flex-column justify-content-center">
                            <div class="img"><img src="https://picsum.photos/id/107/150" alt="" class="w-100">
                                <div class="align-items-baseline d-flex justify-content-between p-1">
                                    <div class="info">
                                        <div class="fs-4 fw-bolder text-black-500"><a
                                                class="text-decoration-none text-first pointer" href="#">Name</a></div>
                    ...
                    <div id='item-slider' data-show='3' class="bg-light h-100 item mx-1 p-3 rounded"
                        style="width:350px;transition:all 1s">
                        <div class="d-flex flex-column justify-content-center">
                            <div class="img"><img src="https://picsum.photos/id/122/150" alt="" class="w-100">
                                <div class="align-items-baseline d-flex justify-content-between p-1">
                                    <div class="info">
                                        <div class="fs-4 fw-bolder text-black-500"><a
                                                class="text-decoration-none text-first pointer" href="#">Name</a></div>
                    ...
                    <div id='item-slider' data-show='3' class="bg-light h-100 item mx-1 p-3 rounded"
                        style="width:350px;transition:all 1s">
                        <div class="d-flex flex-column justify-content-center">
                            <div class="img"><img src="https://picsum.photos/id/108/150" alt="" class="w-100">
                                <div class="align-items-baseline d-flex justify-content-between p-1">
                                    <div class="info">
                                        <div class="fs-4 fw-bolder text-black-500"><a
                                                class="text-decoration-none text-first pointer" href="#">Name</a></div>
                    ...
                    <div id='item-slider' data-show='3' class="bg-light h-100 item mx-1 p-3 rounded"
                        style="width:350px;transition:all 1s">
                        <div class="d-flex flex-column justify-content-center">
                            <div class="img"><img src="https://picsum.photos/id/99/150" alt="" class="w-100">
                                <div class="align-items-baseline d-flex justify-content-between p-1">
                                    <div class="info">
                                        <div class="fs-4 fw-bolder text-black-500"><a
                                                class="text-decoration-none text-first pointer" href="#">Name</a></div>
    ...
    <section class="salts font-amiri mt-5">
        ...
        <div class="align-items-center d-flex flex-column slideSalts w-100" style="transition: all 1s;">
            <div class="d-inline-flex position-relative w-75 overflow-hidden" style="height: 400px;">
                <div class="d-flex items position-relative" style="right: 0px;" id="slideSalts" dir="rtl">
                    <div class="bg-light h-100 item mx-1 p-3 rounded" style="width:350px;">
                        <div class="d-flex flex-column justify-content-center">
                            <div class="img"><img src="https://picsum.photos/id/105/150" alt="" class="w-100">
                                <div class="align-items-baseline d-flex justify-content-between p-1">
                                    <div class="info">
                                        <div class="fs-4 fw-bolder text-black-500"><a
                                                class="text-decoration-none text-first pointer" href="#">Name</a></div>
                    ...
                    <div class="bg-light h-100 item mx-1 p-3 rounded" style="width:350px;">
                        <div class="d-flex flex-column justify-content-center">
                            <div class="img"><img src="https://picsum.photos/id/102/150" alt="" class="w-100">
                                <div class="align-items-baseline d-flex justify-content-between p-1">
                                    <div class="info">
                                        <div class="fs-4 fw-bolder text-black-500"><a
                                                class="text-decoration-none text-first pointer" href="#">Name</a></div>
                    ...
                    <div class="bg-light h-100 item mx-1 p-3 rounded" style="width:350px;">
                        <div class="d-flex flex-column justify-content-center">
                            <div class="img"><img src="https://picsum.photos/150" alt="" class="w-100">
                                <div class="align-items-baseline d-flex justify-content-between p-1">
                                    <div class="info">
                                        <div class="fs-4 fw-bolder text-black-500"><a
                                                class="text-decoration-none text-first pointer" href="#">Name</a></div>
                    ...
                    <div class="bg-light h-100 item mx-1 p-3 rounded" style="width:350px;">
                        <div class="d-flex flex-column justify-content-center">
                            <div class="img"><img src="https://picsum.photos/id/100/150" alt="" class="w-100">
                                <div class="align-items-baseline d-flex justify-content-between p-1">
                                    <div class="info">
                                        <div class="fs-4 fw-bolder text-black-500"><a
                                                class="text-decoration-none text-first pointer" href="#">Name</a></div>
                        ...
                        <div class="d-flex flex-column justify-content-center">
                            <div class="img"><img src="https://picsum.photos/id/100/150" alt="" class="w-100">
                                <div class="align-items-baseline d-flex justify-content-between p-1">
                                    <div class="info">
                                        <div class="fs-4 fw-bolder text-black-500"><a
                                                class="text-decoration-none text-first pointer" href="#">xxxxxxxxxx</a>
                                        </div>
                                        <div class="fs-6 text-black-50">حلويات</div>
                                    </div>
                                    <div>
            ...
            <div class="action mt-3">
                <li class="fa fa-chevron-left mt-1 text-white bg-perso mx-3 p-2 px-5 rounded-pill pointer"
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-3">
                            <div class="chef p-2 rounded" style="height: auto;background: #b1b1b133;">
                                <div class="d-flex flex-column">
                                    <div class="w-100"><img class="w-100" src="https://i.pravatar.cc/300?img=3" alt="">
                                    </div>
                                    ...
                                    <div class="font-italic fs-6 fw-normal m-1 mx-0 specialité text-center"
                                        style="color: #e35516;"><a href="#" class="text-decoration-none "
                        ...
                        <div class="col-3">
                            <div class="chef p-2 rounded" style="height: auto;background: #b1b1b133;">
                                <div class="d-flex flex-column">
                                    <div class="w-100"><img class="w-100" src="https://i.pravatar.cc/300?img=4" alt="">
                                    </div>
                                    <div class="font-italic fs-5 fw-normal mt-1 mx-0 name text-center"><a href="#"
                                            class="text-decoration-none text-info">Mohamed el habib</a></div>
                                    <div class="font-italic fs-6 fw-normal m-1 mx-0 specialité text-center"
                        ...
                        <div class="col-3">
                            <div class="chef p-2 rounded" style="height: auto;background: #b1b1b133;">
                                <div class="d-flex flex-column">
                                    <div class="w-100"><img class="w-100" src="https://i.pravatar.cc/300?img=5" alt="">
                                    </div>
                                    <div class="font-italic fs-5 fw-normal mt-1 mx-0 name text-center"><a href="#"
                                            class="text-decoration-none text-info">Mohamed el habib</a></div>
                                    <div class="font-italic fs-6 fw-normal m-1 mx-0 specialité text-center"
                        ...
                        <div class="col-3">
                            <div class="chef p-2 rounded" style="height: auto;background: #b1b1b133;">
                                <div class="d-flex flex-column">
                                    <div class="w-100"><img class="w-100" src="https://i.pravatar.cc/300?img=6" alt="">
                                    </div>
                                    <div class="font-italic fs-5 fw-normal mt-1 mx-0 name text-center"><a href="#"
                                            class="text-decoration-none text-info">Mohamed el habib</a></div>
                                    <div class="font-italic fs-6 fw-normal m-1 mx-0 specialité text-center"
