<template>
    ...
    <div class="header position-relative overflow-hidden" dir="rtl">
        ...
        <div class="login-icon d-flex flex-row position-absolute" style="left: 2%; top: 2%; z-index: 9991 !important">
        ...
        <div class="index-nav h-auto position-absolute top-0 w-100 z-8888" @mouseleave="hoverLink('leave')">
            ...
            <div class="font-amiri mx-auto nav p-3">
                <li class="fs-4">
                    <a href="#" class="fw-bolder p-2 rounded text-decoration-none link-nav" @mouseenter="hoverLink()"
                    ...
                    <div id="submenu1" @mouseleave="hoverLink('leave')"
                        ...
                        <div class="d-flex justify-content-between position-relative">
                            <div class="mx-1 region w-25">
                                <div style="border-bottom: 1px solid #fcfdff54" class="name-region fs-5 fw-bolder">
                                    شرقية
                                </div>
                                <div class="items">
                <li>
                    <a href="#" class="text-decoration-none fs-6 mb-1 mt-1 text-white">azeaeazzae</a>
                </li>
                <li>
                    <a href="#" class="text-decoration-none fs-6 mb-1 mt-1 text-white">azeaeazzae</a>
                </li>
        ...
        <div class="mx-1 region w-25">
            <div style="border-bottom: 1px solid #fcfdff54" class="name-region fs-5">
                شرقية
            </div>
            <div class="items">
                <li>
    ...
    <li class="fs-4">
        <a data-menu="submenu2" @mouseenter="hoverLink()" href="#" class="fw-bolder p-2 rounded text-decoration-none"
            style="color: white">home</a>

        <div id="submenu2" @mouseleave="hoverLink('leave')" class="p-3 position-absolute mt-3 rounded sub-menu w-50 z-9999"
            style="background: rgb(1, 135, 135); display: none">
            <div class="d-flex justify-content-between position-relative">
                <div class="mx-1 region w-25">
                    <div style="border-bottom: 1px solid #fcfdff54" class="name-region fs-5 fw-bolder">
    ...
    <div class="center-text h-50 position-absolute w-100 z-5555 d-flex justify-content-center flex-column" style="top: 30%">
        <div class="mt-5 mb-5">
        ...
        <div class="steps">
            <div class="container">
                <div class="bg-body h-auto mt-sm-5 mx-sm-auto shape col-12 col-md-9 col-lg-5"
                        ...
                        <div class="col-3">
                            <div class="chef p-2 rounded" style="height: auto; background: #b1b1b133">
                                <div class="d-flex flex-column">
                                    ...
                                    <div>
                                        <a href="#" class="bg-info btn text-white w-100 text-decoration-none">Profile</a>
                                    </div>
                                </div>
                            </div>
                        </div>
